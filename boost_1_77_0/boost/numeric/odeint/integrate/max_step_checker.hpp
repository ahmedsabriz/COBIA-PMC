...
public:
    ...
    void operator()(void)
    {
        ...
        {
            char error_msg[200];
            sprintf_s(error_msg, "Max number of iterations exceeded (%d).", m_max_steps);
...
public:
    ...
    void operator()(void)
    {
        ...
        {
            char error_msg[200];
            sprintf_s(error_msg, "Max number of iterations exceeded (%d). A new step size was not found.", m_max_steps);
