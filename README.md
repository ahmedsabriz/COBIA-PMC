...
middleware. This makes it compatible with any CAPE-OPEN Standard compliant simulator. The unit emulates the behaviour of conventional plug flow reactor with a custom model and operation parameters dedicated to a single process using its built-in reaction package.
