...
//	=================< BzzNonLinearSystemSparse.hpp >=====================
//	* BzzNonLinearSystemSparse class													*
// * Description:																					*
...
////////////////// Release 7.0
// 04-2014	Added constructors with BzzMatrixSparseLocked class.

#ifndef NON_LINEAR_SYSTEM_DOUBLE_SPARSE_HPP
#define NON_LINEAR_SYSTEM_DOUBLE_SPARSE_HPP
...
class BzzNonLinearSystemSparse : public BzzBaseClass
{
protected:
	...
	enum BzzNonLinearSystemSparseWeightsType
	{
		AUTOMATIC_WEIGHTS,
		FIXED_WEIGHTS,
		UNITARY_WEIGHTS
	...
	// LOCKED
	BzzMatrixSparseLocked AL;
	BzzMatrixCoefficientsLocked BL;
	BzzVectorInt rA, cA, nlA;
	BzzVector vA;
	int numElementsA;
	// LOCKED
...
public:
	...
	//	============================================================================
		...
		// default constructor
	BzzNonLinearSystemSparse(void);

	// copy constructor
	BzzNonLinearSystemSparse
	(const BzzNonLinearSystemSparse& rval);
	...
	// Sparse Locked Jacobian
	BzzNonLinearSystemSparse
	(BzzVector& x0,
		void (*ptrS)(BzzVector& xx, BzzVector& ff),
		BzzVectorInt* r, BzzVectorInt* c, BzzVectorInt* nl);
	void operator()
		(BzzVector& x0,
			void (*ptrS)(BzzVector& xx, BzzVector& ff),
			BzzVectorInt* r, BzzVectorInt* c, BzzVectorInt* nl);
...
#endif // NON_LINEAR_SYSTEM_DOUBLE_SPARSE_HPP