...
//	===========================< BzzMinimizationRobust.hpp >================================
//	* The class BzzMinimizationRobust is used for unconstrained						*
// * optimization																					*
// * Description:																					*
//	*					by G. Buzzi-Ferraris														*
// *																									*
// * Examples: BzzMath\examples\BzzMathAdvanced\Minimization\Unconstrained\	*
// *			MinimizationRobust\MinimizationRobust.cpp	*
// * Tests: BzzMath\examples\BzzMathAdvanced\Minimization\Unconstrained\		*
// *			MinimizationRobustTest\											*
// *			MinimizationRobustTest.cpp										*
//	============================================================================

// Revision History (MM-YYYY)
//	Author	Guido Buzzi-Ferraris
//	01-2002	Date Written.

/////// Release 5.0

//	============================================================================
//	******	constructors:																		*
//	* BzzMinimizationRobust m;m(x0,FunMin);													*
//	* BzzMinimizationRobust(x0,FunMin);														*
//	****************************************************************************
...
#ifndef BZZ_SIMPLEX_PLUS_DOUBLE_HPP
#define BZZ_SIMPLEX_PLUS_DOUBLE_HPP

//	============================================================================
//	=================< class BzzMinimizationRobust >==================
//	============================================================================
class BzzMinimizationRobust : public BzzBaseClass
{
...
public:
	...
	//	============================================================================
		// default constructor
	BzzMinimizationRobust(void);

	// copy constructor
	BzzMinimizationRobust
	(const BzzMinimizationRobust& rval);
	...
	BzzMinimizationRobust
	(BzzVector& x00, double ff, double (*ptr)(BzzVector& x));
	void operator ()
		(BzzVector& x00, double ff, double (*ptr)(BzzVector& x));
	...
	BzzMinimizationRobust
	(BzzVector& xxS, double ffS, double (*ptr)(BzzVector& x),
...
#endif // BZZ_SIMPLEX_PLUS_DOUBLE_HPP