...
//	=============< BzzMinimizationMonoVeryRobustObject.hpp >========================
//	* Class BzzMinimizationMonoVeryRobustObject for monodomensional minimization	*
//	==================================================================================

// Revision History (MM-YYYY)
//	Author	Guido Buzzi-Ferraris
//	06-2006	Date Written.
//	05-2008	Added GetUnfeasibleGlobal function.
//	05-2008	Added ResetUnfeasibleGlobal function.

#ifndef MINIMIZATION_DOUBLE_MONO_ROBUST_OBJECT_HPP
#define MINIMIZATION_DOUBLE_MONO_ROBUST_OBJECT_HPP
...
class BzzMinimizationMonoVeryRobustObject : public BzzBaseClass
{
	/*
	private:
	...
	*/
	...
	BzzVector t, y, z, tCriticInf, tCriticSup;
	BzzVector tAux, yAux, tAux1, zAux;
...
public:
	...
	//	============================================================================
		// default constructor
	BzzMinimizationMonoVeryRobustObject(void);

	// copy constructor
	BzzMinimizationMonoVeryRobustObject(const BzzMinimizationMonoVeryRobustObject& rval);

	//	============================================================================
	//	************************< Monodimensional Minimum >*************************
	//	============================================================================
		//	MONO_MONO
		// first constructor BzzMinimizationMonoVeryRobustObject z(t0,y0,ptrO,tMin,tMax);
	BzzMinimizationMonoVeryRobustObject(double tt0, double yy0,
		BzzMyMinimizationRobustObject* ptrO,
		double tmin, double tmax);
	void operator()(double tt0, double yy0, BzzMyMinimizationRobustObject* ptrO,
		double tmin, double tmax);

	// second constructor BzzMinimizationMonoVeryRobustObject z(t0,ptrO,tMin,tMax);
	BzzMinimizationMonoVeryRobustObject(double tt0, BzzMyMinimizationRobustObject* ptrO,
		double tmin, double tmax);
	void operator()(double tt0, BzzMyMinimizationRobustObject* ptrO,
		double tmin, double tmax);

	// third constructor BzzMinimizationMonoVeryRobustObject z(ptrO,tMin,tMax);
	BzzMinimizationMonoVeryRobustObject(BzzMyMinimizationRobustObject* ptrO,
		double tmin, double tmax);
	void operator()(BzzMyMinimizationRobustObject* ptrO,
		double tmin, double tmax);
	...
	//	* x <= U (upper bounds)																		*
		...
		//	UNCONSTRAINED_MULTI,
		BzzMinimizationMonoVeryRobustObject(BzzVector &x00,double FF0,
		...
		BzzMinimizationMonoVeryRobustObject(BzzVector &x00,
			double (*yy)(BzzVector &x),
			BzzVector *xxL,BzzVector *xxU);
	...
	*/
	...
	void GetSolutions(BzzVector* tSolutions, BzzVector* ySolutions, BzzVector* zSolutions);
...
#endif // MINIMIZATION_DOUBLE_MONO_ROBUST_OBJECT_HPP