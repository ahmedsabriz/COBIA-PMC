...
#ifndef MINIMIZATION_MULTI_VERY_ROBUST
#define MINIMIZATION_MULTI_VERY_ROBUST

class BzzMinimizationMultiVeryRobust : public BzzBaseClass
{
private:
...
public:
	...
	//	============================================================================
		// default constructor
	BzzMinimizationMultiVeryRobust(void);

	// copy constructor
	BzzMinimizationMultiVeryRobust(const BzzMinimizationTwoVeryRobust& rval);
...
#endif // MINIMIZATION_MULTI_VERY_ROBUST